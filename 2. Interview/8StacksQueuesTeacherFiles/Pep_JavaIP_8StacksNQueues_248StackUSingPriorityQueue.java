 ...
 * Assign highest priority to top of stack.
 * Max heap of Node class--> data, count(which gives priority value).
 */
	...
	static class Stack {
		...
		// top element has the highest priority, so we make Max Heap
		...
		// Removes top of stack which has highest count value(priority)
		public int pop() {
			if (pq.size() == 0) {
				return -1;
			}
