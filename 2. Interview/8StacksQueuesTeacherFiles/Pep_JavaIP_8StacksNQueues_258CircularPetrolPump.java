...
/**
 * This code does in O(n^2), it chooses all start points.
 *
 * Can be done in O(n) : start = 0 to n, keep track of capacity suppose at some i
 * petrol becomes negative,start = i + 1
 * add negative value to deficit, set  capacity = 0.
 * If on start == n, capacity + deficit > 0, then it's possible to complete tour
 */
