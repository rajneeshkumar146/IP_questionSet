...
/**
 * Done using two stacks, one stack keeps track of data, other stack keeps track of min so far
 * Can be done using one stack : Push objects to stack, with properties data, min so far
 */
