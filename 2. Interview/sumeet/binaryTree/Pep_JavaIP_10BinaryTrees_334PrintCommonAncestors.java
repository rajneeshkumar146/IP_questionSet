...
public class Pep_JavaIP_10BinaryTrees_334PrintCommonAncestors {
	...
	private static boolean lca(Node node, int d1, int d2, int level) {
		if (node == null) {
			return false;
		} else if (lca != null) { // this case is special here - it can be used as optimization in last two questions
			return true;
		}
